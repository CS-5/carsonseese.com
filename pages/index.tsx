  ...
  return (
    <>
      ...
      <div className="overflow-auto">
        ...
        {/*                                                                                                     Note: backdrop-blur does not currently work on Firefox */}
        <div className="fixed font-sans antialiased text-gray-900 leading-normal tracking-wider h-full w-full backdrop-blur-sm">
            ...
            >
              <div className="p-4 md:p-12 text-center lg:text-left">
                ...
                <p className="pt-8 text-sm">
                  ...
                  frequent hiker/biker/kayaker. Mostly Go/TS dev but I try not
                  to have favorites.
                </p>
